...
export const BrandsRu: React.FC = () => {
  ...
  const motorBrands = [
    ...
    { name: "TONG HONG GASKETS", category: "Моторные части", logo: "/17.png" },
  ...
  const hodovyeBrands = [
    { name: "", category: "Ходовые части", logo: "/11.png" },
    { name: "", category: "Ходовые части", logo: "/12.png" },
    { name: "", category: "Ходовые части", logo: "/13.png" },
    { name: "Амортизаторы", category: "Ходовые части", logo: "/14.png" },
    { name: "Амортизаторы", category: "Ходовые части", logo: "/15.png" },
    { name: "Амортизаторы", category: "Ходовые части", logo: "/16.png" },
  ];

  // Тормозные части и трансмиссии - 5 карточек
  const tormoznyeBrands = [
    { name: "", category: "Тормозные колодки", logo: "/20.png" },
    { name: "", category: "Тормозные диски", logo: "/21.png" },
    { name: "Гидравлические части тормоза", category: "Тормозная жидкость", logo: "/22.png" },
    { name: "", category: "Трансмиссионное масло", logo: "/23.png" },
    { name: "", category: "Сцепление", logo: "/24.png" },
  ];

  // Кузовные части / Рестайлинг - 4 карточки
  const kuzovnyeBrands = [
    { name: "Кузовные компоненты", category: "Бамперы", logo: "/27.png" },
    { name: "Фары", category: "Фары", logo: "/28.png" },
    { name: "Фары", category: "Зеркала", logo: "/30.png" },
    { name: "Кузовные части", category: "Молдинги", logo: "/31.png" },
  ];
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-16">
            ...
            {hodovyeBrands.map((brand, index) => (
              <div 
                ...
                className="group brand-card-animated"
                style={{ animationDelay: `${3.7 + index * 0.05}s` }}
              >
                {/* Прямоугольная карточка с градиентом */}
                <div className="bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm rounded-xl p-1 hover:from-gray-700/90 hover:to-gray-800/90 transition-all duration-300 flex items-center justify-center overflow-hidden border border-[#144374]/20 hover:border-[#144374]/40 relative shadow-lg hover:shadow-[#144374]/10 hover:shadow-xl transform hover:scale-105" style={{ width: '140px', height: '100px' }}>
                  <img 
            ...
            {tormoznyeBrands.map((brand, index) => (
              <div 
                ...
                className="group brand-card-animated"
                style={{ animationDelay: `${4 + index * 0.05}s` }}
              >
                {/* Прямоугольная карточка с градиентом */}
                <div className="bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm rounded-xl p-1 hover:from-gray-700/90 hover:to-gray-800/90 transition-all duration-300 flex items-center justify-center overflow-hidden border border-[#144374]/20 hover:border-[#144374]/40 relative shadow-lg hover:shadow-[#144374]/10 hover:shadow-xl transform hover:scale-105" style={{ width: '140px', height: '100px' }}>
                  <img 
            ...
            {kuzovnyeBrands.map((brand, index) => (
              <div 
                ...
                className="group brand-card-animated"
                style={{ animationDelay: `${4.3 + index * 0.05}s` }}
              >
                {/* Прямоугольная карточка с градиентом */}
                <div className="bg-gradient-to-br from-gray-800/90 to-gray-900/90 backdrop-blur-sm rounded-xl p-1 hover:from-gray-700/90 hover:to-gray-800/90 transition-all duration-300 flex items-center justify-center overflow-hidden border border-[#144374]/20 hover:border-[#144374]/40 relative shadow-lg hover:shadow-[#144374]/10 hover:shadow-xl transform hover:scale-105" style={{ width: '140px', height: '100px' }}>
                  <img 
            ...
            {/* Моторное масло */}
            {[
              { name: "Моторное масло", category: "Синтетическое масло", logo: "/eneos.png" },
              { name: "Моторные масла", category: "Полусинтетическое масло", logo: "/eneos.png" },
              { name: "Моторное масло", category: "Минеральное масло", logo: "/eneos.png" },
              { name: "Топливный насос", category: "Топливная система", logo: "/32.png" },
              { name: "Моторное масло", category: "Премиальное масло", logo: "/eneos.png" },
              { name: "Моторное масло", category: "Премиальное масло", logo: "/eneos.png" },
              { name: "Поршни и гильзы", category: "Моторные части", logo: "/33.png" },
              { name: "Моторные масла", category: "Оригинальное масло", logo: "/eneos.png" },
              { name: "Моторное масло", category: "Синтетическое масло", logo: "/eneos.png" },
              { name: "Фильтры", category: "Фильтрация", logo: "/16.png" },
            ].map((brand, index) => (
              <div 
